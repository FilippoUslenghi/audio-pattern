...
\begin{abstract}
This study evaluates several traditional machine learning models — K-NN, SVM, MLP and Random Forest — on the ESC-10 dataset. Features such as MFCCs and ZCR were extracted from audio signals, and each model was optimized using cross-validation. The results show that all models outperformed a baseline dummy classifier, with Random Forest achieving the highest accuracy. This study highlights the potential of traditional machine learning methods for ESC and identifies the most challenging and easily classified sound categories.
\end{abstract}
